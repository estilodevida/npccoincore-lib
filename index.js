...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of npccoincore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of npccoincore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._npccoincore);
global._npccoincore = bitcore.version;
