# NPCcoin Address
Represents a NPCcoin address. Addresses are the most popular way to make NPCcoin transactions. See [the NPCcoin documentation](https://npccoin-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/npccoin/bitcore-npccoin/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/npccoin/bitcore-npccoin/tree/master/lib/errors/spec.js).
