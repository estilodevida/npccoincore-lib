# Contributing to npccoincore-lib

We're working hard to make *npccoincore-lib* the most powerful JavaScript library for working with NPCcoin. Our goal is to have *npccoincore-lib* be a library that can be used by anyone interested in NPCcoin, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://www.npccoin.com/forum (Support Forum)
...
These are some global design goals in npccoincore-lib that any change must adhere.
...
When possible, npccoincore-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of npccoincore-lib methods. For example, calling `JSON.stringify` on an npccoincore-lib object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'npccoincore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the npccoincore object.

DO:
```javascript
var npccoincore = require('../');
var PublicKey = npccoincore.PublicKey;
```
DON'T:
```javascript
...
```sh
git remote add npccoin git@github.com:npccoin/npccoincore-lib.git
...
```
Finally go to [github.com/npccoin/npccoincore-lib](https://github.com/npccoin/npccoincore-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of npccoincore-lib.

If you have any questions feel free to post them to
[github.com/npccoin/npccoincore-lib/issues](https://github.com/npccoin/npccoincore-lib/issues).
